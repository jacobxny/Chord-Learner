...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      {/* Header */}
      <div className="bg-gradient-to-r from-amber-700 to-orange-600 dark:from-gray-800 dark:to-gray-700 text-white">
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="text-center text-amber-100 dark:text-gray-300 text-lg max-w-2xl mx-auto">
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-colors ${
              activeTab === 'chords'
                ...
                : 'bg-white text-amber-700 border-2 border-amber-300 hover:bg-amber-50 dark:bg-gray-800 dark:text-amber-400 dark:border-amber-600 dark:hover:bg-gray-700'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-colors ${
              activeTab === 'scales'
                ...
                : 'bg-white text-green-700 border-2 border-green-300 hover:bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-600 dark:hover:bg-gray-700'
            }`}
          >
        ...
        <div className="mb-12">
          <div className="flex items-center justify-center gap-2 mb-6">
            {activeTab === 'chords' ? (
              <>
                <Music2 className="h-6 w-6 text-amber-600 dark:text-amber-400" />
                <h2 className="text-2xl font-semibold text-amber-900 dark:text-amber-300">Find Your Chord</h2>
              </>
            ) : (
              <>
                <Waves className="h-6 w-6 text-green-600 dark:text-green-400" />
                <h2 className="text-2xl font-semibold text-green-900 dark:text-green-300">Find Your Scale</h2>
              </>
            )}
          </div>
          {activeTab === 'chords' ? (
        ...
        {showPopularChords && (
          <div className="mb-12">
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <h2 className="text-2xl font-semibold text-amber-900 dark:text-amber-300">
        ...
        {/* Legend */}
        <div className="mt-16 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 max-w-2xl mx-auto border-2 border-amber-200 dark:border-gray-600">
          <h3 className="text-xl font-bold text-amber-900 dark:text-amber-300 mb-4 text-center">How to Read Diagrams</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div>
              <div className="w-8 h-8 bg-gray-800 dark:bg-gray-600 rounded-full mx-auto mb-2 flex items-center justify-center text-white font-bold">1</div>
              <p className="text-sm text-amber-800 dark:text-amber-300">Numbers show which finger to use (chords)</p>
            </div>
            <div>
              <div className="w-8 h-8 border-2 border-green-600 dark:border-green-400 rounded-full mx-auto mb-2"></div>
              <p className="text-sm text-amber-800 dark:text-amber-300">Open circles = open strings</p>
            </div>
            <div>
              <div className="w-8 h-8 bg-green-600 dark:bg-green-500 rounded-full mx-auto mb-2"></div>
              <p className="text-sm text-amber-800 dark:text-amber-300">Green dots = scale positions</p>
            </div>
          </div>
        </div>
      </div>
